                                                    ...
                                                    <section id="contact" class="contact">
                                                        ...
                                                        <div class="row" data-aos="fade-up" data-aos-delay="100">
                                                                ...
                                                                <div class="row" >
                                                                    ...
                                                                    <div class="col form-group" style="border:2px solid skyblue;">
                                                                        <img class="img_size" src="/feedbackimage/{{$feed->image}}" alt="image">
                                                                    </div>
                                                                </div>
                                                                @else
                                                                ...
                                                                <div class="row" >
                                                                    <div class="col form-group">
                                                                        <h5><b>Category :</b> {{$feed->category}}</h5>
                                                                    </div>
                                                                    <div class="col form-group">
                                                                    <h5><b>Submit By :</b> {{$feed->user_name}}</h5>
                                                                    </div>
                                                                </div>
                                                            
                                                            </div>
                                                                                <form action="{{url('/upvote',$feed->id)}}" method="post">
                                                                                    @csrf 
                                                                                    <button type="submit" class="btn btn-success">Upvote</button>      
                                                                                </form><br>
                                                                                <form action="{{url('/downvote',$feed->id)}}" method="post">
                                                                                    @csrf
                                                                ...
                                                                <div style="padding-top:50px;">   
                                                                    ...
                                                                    @if (session()->has('message'))
                                                                        ...
                                                                        <form action="{{url('add_comment',$feed->id)}}" method="post">
                                                                            @csrf
                                                                ...
                                                                @if($feed->title==$comment->feedback_title)                                                                <div style="padding-left:20%;">
                                                                    <h1 style="font-size:30px; padding-bottom:30px;">All Comments</h1>
                                                                    <div>
                                                                        <b>{{$comment->name}}</b>
                                                                        <p>{{$comment->comment}}</p>
                                                                        <sub>{{$comment->created_at}}</sub><br>
                                                                ...
                                                                @endforeach
                                                                    ...
                                                                    <form action="{{url('reply',$feed->id)}}" method="post">
                                                                               @csrf
